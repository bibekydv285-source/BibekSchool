        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalObtainedMarks = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalFullMarks = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marks_StudentId_SubjectId_ExamName_AcademicYear",
                table: "Marks",
                columns: new[] { "StudentId", "SubjectId", "ExamName", "AcademicYear" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Results_StudentId_AcademicYear_Term",
                table: "Results",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolClasses_Name_Section_AcademicYear",
                table: "SchoolClasses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherAssignments_TeacherId_ClassId_SubjectId_AcademicYear",
                table: "TeacherAssignments",
                columns: new[] { "TeacherId", "ClassId", "SubjectId", "AcademicYear" },
                unique: true);
